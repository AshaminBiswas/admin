...
import { inventoryApi, fetchAdminApi, barcodeApi } from '../api/adminApi';
import type {
  Branch,
  Supplier,
  InventoryItem,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white dark:bg-[#18181B] p-4 rounded-2xl border border-slate-200 dark:border-[#27272A] shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1 sm:pt-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 bg-[#8B5CF6]/15 hover:bg-[#8B5CF6]/25 border border-[#8B5CF6]/30 text-[#8B5CF6] text-xs font-bold rounded-xl shadow-sm transition-all active:scale-95"
          >
                    ...
                    <div className="flex items-center justify-between gap-1.5 pt-1">
                      ...
                      <button
                        onClick={() => {
                          ...
                          if (sku) barcodeApi.downloadLabelPdf(sku);
                        }}
                        className="flex-1 py-1.5 bg-violet-500/10 text-violet-600 dark:text-violet-400 hover:bg-violet-500 hover:text-white rounded-lg text-[11px] font-bold transition flex items-center justify-center gap-1"
                        ...
                        <td className="py-3 px-4 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <button
                              ...
                              title="Download Thermal Barcode Label"
                              className="px-2 py-1 bg-violet-500/10 hover:bg-violet-500 text-violet-600 dark:text-violet-400 hover:text-white rounded-lg text-[11px] font-bold transition flex items-center gap-1"
                            >
                              <Printer className="w-3 h-3" />
                              <span>Label</span>
                            </button>
